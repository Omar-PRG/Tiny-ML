...
The main goal of this project is to integrate machine learning with arduino ide using the arduino Nano 33 BLE Sense MCu and thanks to the TensorFlow Lite Library.
